...
public class GLFW
{
    ...
    static {
        try {
            System.load(System.getenv("BUNDLE_PATH") + "/PocketJLauncher");
    ...
    private static final SharedLibrary GLFW = new MacOSXLibraryDL("PocketJLauncher", DynamicLinkLoader.RTLD_DEFAULT);
