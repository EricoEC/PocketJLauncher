...
## Request official Stik support

After completing Part 1, Part 2, or both, get in touch with us in the [idevice Discord server](https://discord.gg/qtgv6QtYbV) so we can offer official Stik support to your users. We review app submissions on a case-by-case basis and generally decline projects without an established user base, low-quality substantially AI-generated projects, and forks of apps that already have official Stik support.
